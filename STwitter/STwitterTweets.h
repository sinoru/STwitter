...
+ (id)showStatus:(NSNumber *)tweetID account:(ACAccount *)account includeEntities:(BOOL)includeEntities includeMyRetweet:(BOOL)includeMyRetweet trimUser:(BOOL)trimUser error:(out NSError **)error __OSX_AVAILABLE_STARTING(__MAC_10_8,__IPHONE_5_0);
...
+ (id)showStatus:(NSNumber *)tweetID OAuthConsumerKey:OAuthConsumerKey OAuthConsumerSecret:OAuthConsumerSecret OAuthAccessToken:(NSString *)OAuthAccessToken OAuthAccessTokenSecret:(NSString *)OAuthAccessTokenSecret includeEntities:(BOOL)includeEntities includeMyRetweet:(BOOL)includeMyRetweet trimUser:(BOOL)trimUser error:(out NSError **)error;
